...
class RectangularRoom(object):
    ...
    def clean_tile_at_position(self, pos, capacity):
        ...
        current_dirt = self.tiles[(m,n)]
        self.tiles[(m,n)] = max(0, current_dirt - capacity)
    ...
    def get_num_cleaned_tiles(self):
        ...
        count = 0
        for clean in self.tiles.values():
            if clean == 0:
                count += 1
        return count
...
class Robot(object):
    ...
    def get_robot_direction(self):
        """
       xx Returns: a float d giving the direction of the robot as an angle in
        degrees, 0.0 <= d < 360.0.
        """
